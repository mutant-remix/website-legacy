...
<img src="/assets/remix_release_v1.png" className={styles.header}></img>
...
- Our first release! <Emoji path="expressions/smileys/happy_fun/party_face" />
...
export default ({ children }) => <Layout title="Release 1.0">{children}</Layout>
