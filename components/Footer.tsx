...
export function Footer({ light }: Props) {
    return (
        <div className={styles.footer} data-light={light}>
            <div className={styles.links}><Link href="/download">Download</Link> &middot; <Link href="/demo">Demo</Link> &middot; <a href={DISCORD_INVITE} target="_blank">Discord Server</a></div>
