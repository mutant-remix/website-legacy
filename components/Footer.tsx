...
export function Footer({ light }: Props) {
    return (
        <div className={styles.footer} data-light={light}>
            <div className={styles.links}><Link href="/download"><a>Download</a></Link> &middot; <Link href="/demo"><a>Demo</a></Link> &middot; <Link href="/changelog"><a>Changelog</a></Link> &middot; <a href={DISCORD_INVITE} target="_blank">Discord Server</a></div>
